...
#if defined(NDEBUG)
# error "Nocoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Nocoin Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Nocoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Nocoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
