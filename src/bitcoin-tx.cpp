...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Nocoin Core nocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nocoin transaction") + "\n" +
              "  nocoin-tx [options] -create [commands]   " + _("Create hex-encoded nocoin transaction") + "\n" +
              "\n";
